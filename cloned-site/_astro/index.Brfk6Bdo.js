...
, $ = Array.isArray, Ne = /(?:-?\.?\d|\.)+/gi, Li = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Ut = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Me = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Ii = /[+-]=-?[.\d]+/, Ni = /[^,'"\[\]\s]+/gi, Lr = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, E, ft, Be, ei, nt = {}, xe = {}, Bi, Vi = function(t) {
    ...
    var i = t._dp;
    return i && i.smoothChildTiming && t._ts && (t._start = B(i._time - (t._ts > 0 ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts)),
    ke(t),
    i._dirty || Ft(i, t)),
    t
}, Ki = function(t, e) {
    var i;
    if ((e._time || !e._dur && e._initted || e._start < t._time && (e._dur || !e.add)) && (i = we(t.rawTime(), e),
    (!e._dur || ce(0, e.totalDuration(), i) - e._tTime > W) && e.render(i, !0)),
    ...
    if (a && t._repeat && (o = ce(0, t._tDur, e),
    h = Kt(o, a),
    t._yoyo && h & 1 && (s = 1 - s),
    ...
    s !== n || q || r || t._zTime === W || !e && t._zTime) {
        ...
        !i && !q && (it(t, s ? "onComplete" : "onReverseComplete", !0),
        t._prom && t._prom()))
    } else
        t._zTime || (t._zTime = e)
}, Wr = function(t, e, i) {
    ...
    return Y(e) && (isNaN(e) || e in r) ? (o = e.charAt(0),
    f = e.substr(-1) === "%",
    a = e.indexOf("="),
    o === "<" || o === ">" ? (a >= 0 && (e = e.replace(/=/, "")),
    ...
    function(c, d, p) {
        ...
        if (!m) {
            ...
            for (m = s[_] = [],
            y = o ? Math.min(w, _) * h - .5 : r % w,
            x = w === lt ? 0 : o ? _ * l / w - .5 : r / w | 0,
            P = 0,
            O = lt,
            b = 0; b < _; b++)
                v = b % w - y,
    ...
    (n = !yt(t[0])) && (r *= r)) : t = Ge(t.increment)),
    kt(e, i ? F(t) ? function(s) {
        return n = t(s),
        Math.abs(n - s) <= r ? n : s
    }
    : function(s) {
    ...
    for (var e = 0, i = "", r, n, s, a; ~(r = t.indexOf("random(", e)); )
        ...
        i += t.substr(e, r - e) + er(a ? n : +n[0], a ? 0 : +n[1], +n[2] || 1e-5),
        e = s + 1;
    ...
    return l = {
        ...
        sleep: function() {
            (h ? cancelAnimationFrame : clearTimeout)(o),
            fe = 0,
            f = oe
        },
  ...
  , he = function() {
    ...
    t.totalTime = function(i, r) {
        ...
        if (n && n.smoothChildTiming && this._ts) {
            for (Ce(this, i),
            !n._dp || n.parent || Ki(n, this); n && n.parent; )
        ...
        return (this._tTime !== i || !this._dur && !r || this._initted && Math.abs(this._zTime) === W || !i && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = i),
        qi(this, i, r)),
        this
    }
    ,
    ...
    t.paused = function(i) {
        ...
        this._ts = this._rts,
        this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== W && (this._tTime -= W)))),
        this) : this._ps
    }
    ,
    t.startTime = function(i) {
        if (arguments.length) {
            ...
            return r && (r._sort || !this.parent) && ht(r, this, i - this._delay),
            this
        }
        return this._start
    }
...
var K = function(u) {
    ...
    return e.to = function(r, n, s) {
        return ne(0, arguments, this),
        this
    }
    ,
    e.from = function(r, n, s) {
        return ne(1, arguments, this),
        this
    }
    ,
    e.fromTo = function(r, n, s, a) {
        return ne(2, arguments, this),
        this
    }
    ,
    ...
    e.render = function(r, n, s) {
        ...
        h !== this._tTime || s || l) {
            ...
            if (this._hasPause && !this._forcing && this._lock < 2 && (x = Wr(this, B(a), B(c)),
            x && (h -= c - (c = x._start))),
            this._tTime = h,
            this._time = c,
            this._act = !v,
            ...
            if (c >= a && r >= 0)
                ...
                for (var k = r < 0 ? r : c; d; ) {
                    if (p = d._prev,
                    (d._act || k <= d._end) && d._ts && x !== d) {
                        if (d.parent !== this)
                            return this.render(r, n, s);
                        if (d.render(d._ts > 0 ? (k - d._start) * d._ts : (d._dirty ? d.totalDuration() : d._tDur) + (k - d._start) * d._ts, n, s || q && (d._initted || d._startAt)),
                        c !== this._time || !this._ts && !y) {
                            x = 0,
                            p && (h += this._zTime = k ? -1e-8 : W);
                            break
                        }
                    }
                    d = p
            ...
            !n && !(r < 0 && !a) && (h || a || !o) && (it(this, h === o && r >= 0 ? "onComplete" : "onReverseComplete", !0),
    ...
    e.getChildren = function(r, n, s, a) {
        ...
        for (var o = [], f = this._first; f; )
            f._start >= a && (f instanceof N ? n && o.push(f) : (s && o.push(f),
    ...
    ,
    e.remove = function(r) {
        return Y(r) ? this.removeLabel(r) : F(r) ? this.killTweensOf(r) : (r.parent === this && Se(this, r),
    ...
    e.totalTime = function(r, n) {
        ...
        !this._dp && this._ts && (this._start = B(et.time - (this._ts > 0 ? r / this._ts : (this.totalDuration() - r) / -this._ts))),
    ...
    e.getTweensOf = function(r, n) {
        for (var s = [], a = ot(r), o = this._first, f = yt(n), h; o; )
            o instanceof N ? Br(o._targets, a) && (f ? (!vt || o._initted && o._ts) && o.globalTime(0) <= n && o.globalTime(o.totalDuration()) > n : !n || o.isActive()) && s.push(o) : (h = o.getTweensOf(a, n)).length && s.push.apply(s, h),
            o = o._next;
        return s
    }
    ,
    ...
    e.totalDuration = function(r) {
        ...
        if (s._dirty) {
            for (l = s.parent; a; )
                ...
                ht(s, a, h - a._delay, 1)._lock = 0) : o = h,
                h < 0 && a._ts && (n -= h,
                ...
                a = f;
            Qt(s, s === E && s._time > n ? s._time : n, 1, 1),
            s._dirty = 0
        }
        return s._tDur
    }
...
var fn = function(t, e, i, r, n, s, a) {
    ...
    if (Y(r) && (~r.indexOf("random(") && (r = ue(r)),
    r.charAt(1) === "=" && (p = Xt(c, r) + (G(c) || 0),
    (p || p === 0) && (r = p))),
    !h || c !== r || We)
        return !isNaN(c * r) && r !== "" ? (p = new j(this._pt,t,e,+c || 0,r - (c || 0),typeof l == "boolean" ? mn : gr,0,d),
        f && (p.fp = f),
        a && p.modifier(a, this, t),
        this._pt = p) : (!l && !(e in t) && ii(e, r),
        fn.call(this, t, e, c, r, d, o || rt.stringFilter, f))
}, hn = function(t, e, i, r, n) {
    if (F(t) && (t = se(t, n, e, i, r)),
    ...
    var a, o, f, h;
    if (tt[t] && (a = new tt[t]).init(n, a.rawVars ? e[t] : hn(e[t], r, n, s, i), i, r, s) !== !1 && (i._pt = o = new j(i._pt,n,t,0,1,a.render,a,0,a.priority),
    i !== Yt))
    ...
    !T || c && !r.stagger) {
        ...
        b = 0; b < m.length; b++) {
            ...
            V = x === m ? b : x.indexOf(w),
            M && (D = new M).init(w, I || g, t, V, x) !== !1 && (t._pt = O = new j(t._pt,w,D.name,0,1,D.render,D,0,D.priority),
...
var N = function(u) {
    ...
    function t(i, r, n, s) {
        ...
        if (a._targets = v.length ? si(v) : ae("GSAP target " + i + " not found. https://gsap.com", !rt.nullTargetWarn) || [],
        a._ptLookup = [],
        a._overwrite = d,
        p || c || pe(f) || pe(h)) {
            if (r = a.vars,
            ...
            c || pe(f) || pe(h)) {
                ...
                for (g = 0; g < P; g++)
                    ...
                    !c && P === 1 && b.delay && (a._delay = h = b.delay,
                    a._start += h,
                    b.delay = 0),
            ...
            a.timeline = 0;
        return d === !0 && !He && (vt = mt(a),
        E.killTweensOf(v),
        vt = 0),
        ht(x, mt(a), n),
        r.reversed && a.reverse(),
        r.paused && a.paused(!0),
        (l || !f && !p && a._start === B(x._time) && Q(l) && Xr(mt(a)) && x.data !== "nested") && (a._tTime = -1e-8,
        ...
        if (!f)
            ...
            this._repeat) {
                ...
                c === a && !s && this._initted && p === m)
                    ...
                    this;
                p !== m && (v && this._yEase && hr(v, y),
                this.vars.repeatRefresh && !y && !this._lock && c !== _ && this._initted && (this._lock = s = 1,
            ...
            c && !a && !n && !p && (it(this, "onStart"),
            this._tTime !== l))
                return this;
            for (d = this._pt; d; )
                d.r(x, d.d),
                d = d._next;
            v && v.render(r < 0 ? r : v._dur * v._ease(c / this._dur), n, s) || this._startAt && (this._zTime = r),
            this._onUpdate && !n && (h && Ue(this, r, n, s),
            it(this, "onUpdate")),
            this._repeat && p !== m && this.vars.onRepeat && !n && this.parent && it(this, "onRepeat"),
            (l === this._tDur || !l) && this._tTime === l && (h && !this._onUpdate && Ue(this, r, !0, !0),
            (r || !f) && (l === this._tDur && this._ts > 0 || !l && this._ts < 0) && Ot(this, 1),
            !n && !(h && !a) && (l || a || y) && (it(this, l === o ? "onComplete" : "onReverseComplete", !0),
    ...
    e.resetTo = function(r, n, s, a, o) {
        ...
        return this._initted || oi(this, f),
        h = this._ease(f / this._dur),
        _n(this, r, n, s, a, h, f, o) ? this.resetTo(r, n, s, a, 1) : (Ce(this, 0),
        this.parent || $i(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0),
        this.render(0))
    }
    ,
    e.kill = function(r, n) {
        ...
        if (this.timeline) {
            ...
            return this.timeline.killTweensOf(r, n, vt && vt.vars.overwrite !== !0)._first || ee(this),
        ...
        y = a.length; y--; )
            if (~o.indexOf(a[y])) {
                ...
                for (_ in p)
                    m = c && c[_],
                    m && ((!("kill"in m.d) || m.d.kill(_) === !0) && Se(this, m, "_pt"),
                    delete c[_]),
                    d !== "all" && (d[_] = 1)
            }
        return this._initted && !this._pt && h && ee(this),
        this
    }
    ,
    t.to = function(r, n) {
...
var It = []
  ...
  , vr = function() {
    ...
    t.kill = function(i, r) {
        ...
        if (i ? function() {
            ...
            o = n.data.length; o--; )
                f = n.data[o],
                f instanceof K ? f.data !== "nested" && (f.scrollTrigger && f.scrollTrigger.revert(),
                f.kill()) : !(f instanceof N) && f.revert && f.revert(i);
  ...
  , wn = function() {
    ...
    return t.add = function(i, r, n) {
        ...
        s.queries = i;
        for (f in i)
            f === "all" ? h = 1 : (o = ft.matchMedia(i[f]),
            o && (It.indexOf(s) < 0 && It.push(s),
            (a[f] = o.matches) && (h = 1),
  ...
  , be = {
    ...
    defaults: function(t) {
        return t && t.ease && (t.ease = Lt(t.ease, Wt.ease)),
        gi(Wt, t || {})
    },
    config: function(t) {
        return gi(rt, t || {})
    ...
    exportRoot: function(t, e) {
        ...
        r = E._first; r; )
            n = r._next,
            (e || !(!r._dur && r instanceof N && r.vars.onComplete === r._targets[0])) && ht(i, r, r._start - r._delay),
            r = n;
        return ht(E, i, 0),
        i
    },
...
var bi, Tt, qt, _i, Et, Pi, li, On = function() {
    ...
    if (this.tfm) {
        ...
        n = li(),
        (!n || !n.isStart) && !i[z] && (br(i),
        r.zOrigin && i[H] && (i[H] += " " + r.zOrigin + "px",
        r.zOrigin = 0,
        r.renderTransform()),
        r.uncache = 1)
    }
    ...
    e && t.style && t.nodeType && e.split(",").forEach(function(r) {
        return i.save(r)
    }),
    i
}, Or, Qe = function(t, e) {
    ...
    return e && (e.width || e.height) || i || (e = ki(t)),
    e && !e.width && !e.x && !e.y ? {
        x: +Ci(t, ["x", "cx", "x1"]) || 0,
        y: +Ci(t, ["y", "cy", "y1"]) || 0,
        width: 0,
    ...
    if (e) {
        ...
        i.removeProperty(r === "--" ? e : e.replace(ci, "-$1").toLowerCase())) : i.removeAttribute(e)
    }
    ...
    if (r === s || !n || Mi[r] || Mi[s])
        return n;
    if (s !== "px" && !c && (n = u(t, e, i, "px")),
    y = t.getCTM && kr(t),
    (d || s === "%") && (xt[e] || ~e.indexOf("adius")))
        return p = y ? t.getBBox()[o ? "width" : "height"] : t[h],
        L(d ? n / p * l : n / 100 * p);
    if (a[o ? "width" : "height"] = l + (c ? s : r),
    _ = r !== "rem" && ~e.indexOf("adius") || r === "em" && t.appendChild && !f ? t : t.parentNode,
    ...
    if (d && (e === "height" || e === "width")) {
        ...
        t.style[e] = l + r,
        p = t[h],
        x ? t.style[e] = x : Nt(t, e)
    } else
        (d || s === "%") && !Bn[ct(_, "display")] && (a.position = ct(t, "position")),
    ...
    var n;
    return _i || Ze(),
    e in _t && e !== "transform" && (e = _t[e],
    ~e.indexOf(",") && (e = e.split(",")[0])),
    xt[e] && e !== "transform" ? (n = le(t, r),
    n = e !== "transformOrigin" ? n[e] : n.svg ? n.origin : Oe(ct(t, H)) + " " + n.zOrigin + "px") : (n = t.style[e],
    (!n || n === "auto" || r || ~(n + "").indexOf("calc(")) && (n = Pe[e] && Pe[e](t, e, i) || ct(t, e) || Xi(t, e) || (e === "opacity" ? 1 : 0))),
    ...
    if (!i || i === "none") {
        var n = jt(e, t, 1)
          , s = n && ct(t, n, 1);
        s && s !== i ? (e = n,
        i = s) : e === "borderColor" && (i = ct(t, "borderTopColor"))
    }
    ...
    n.join(",") === "1,0,0,1,0,0" ? _e : n) : (n === _e && !t.offsetParent && t !== qt && !i.svg && (o = r.display,
    r.display = "block",
    s = t.parentNode,
    (!s || !t.offsetParent && !t.getBoundingClientRect().width) && (f = 1,
    ...
    return h = l = c = _ = m = y = x = v = T = 0,
    d = p = 1,
    i.svg = !!(t.getCTM && kr(t)),
    o.translate && ((o.translate !== "none" || o.scale !== "none" || o.rotate !== "none") && (r[z] = (o.translate !== "none" ? "translate3d(" + (o.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (o.rotate !== "none" ? "rotate(" + o.rotate + ") " : "") + (o.scale !== "none" ? "scale(" + o.scale.split(" ").join(",") + ") " : "") + (o[z] !== "none" ? o[z] : "")),
    r.scale = r.rotate = r.translate = "none"),
    P = di(t, i.svg),
    i.svg && (i.uncache ? (ut = t.getBBox(),
    ...
    h = V = P[4],
    l = I = P[5],
    P.length === 6 ? (d = Math.sqrt(A * A + M * M),
    p = Math.sqrt(X * X + D * D),
    _ = A || M ? Vt(M, A) * Rt : 0,
    x = D || X ? Vt(D, X) * Rt + _ : 0,
    ...
    Math.abs(x) > 90 && Math.abs(x) < 270 && (n ? (d *= -1,
    x += _ <= 0 ? 180 : -180,
    _ += _ <= 0 ? 180 : -180) : (p *= -1,
    x += x <= 0 ? 180 : -180)),
    e = e || i.uncache,
    ...
    (r || n) && (T += "translate(" + r + "%, " + n + "%) "),
    (g || s !== te || a !== te || o !== te) && (T += o !== te || g ? "translate3d(" + s + ", " + a + ", " + o + ") " : "translate(" + s + ", " + a + At),
    f !== Dt && (T += "rotate(" + f + At),
    h !== Dt && (T += "rotateY(" + h + At),
    l !== Dt && (T += "rotateX(" + l + At),
    ...
    O = c,
    b = P = 0),
    (v && !~(s + "").indexOf("px") || T && !~(a + "").indexOf("px")) && (v = St(d, "x", s, "px"),
    T = St(d, "y", a, "px")),
    (p || _ || m || y) && (v = L(v + p - (p * g + _ * P) + m),
    T = L(T + _ - (p * b + _ * O) + y)),
    (r || n) && (w = d.getBBox(),
    v = L(v + r / 100 * w.width),
    T = L(T + n / 100 * w.height)),
    w = "matrix(" + g + "," + b + "," + P + "," + O + "," + v + "," + T + ")",
    ...
    l === "short" && (f %= s,
    f !== f % (s / 2) && (f += f < 0 ? s : -360)),
    l === "cw" && f < 0 ? f = (f + s * Oi) % s - ~~(f / s) * s : l === "ccw" && f > 0 && (f = (f - s * Oi) % s - ~~(f / s) * s)),
    ...
    a = le(i, 1),
    Nt(i, z),
    i.setAttribute("transform", f)) : (f = getComputedStyle(i)[z],
    s[z] = e,
    a = le(i, 1),
    s[z] = f);
    for (o in xt)
...
var Ar = {
            ...
            !(tt[_] && cr(_, e, i, r, t, n)))) {
                ...
                p)
                    ...
                    v) {
                        ...
                        T.dep = 1),
                        _ === "scale")
                            this._pt = new j(this._pt,g,"scaleY",g.scaleY,(x ? Xt(g.scaleY, x + l) : l) - g.scaleY || 0,Ke),
                            this._pt.u = 0,
                            s.push("scaleY", _),
                            _ += "X";
                            ...
                            O.push(H, 0, a[H]),
                            h = Un(h),
                            g.svg ? je(t, h, 0, b, 0, this) : (y = parseFloat(h.split(" ")[2]) || 0,
                    ...
                    if (v || (l || l === 0) && (c || c === 0) && !kn.test(h) && _ in a)
                        ...
                        m !== y && (c = St(t, _, f, y)),
                        this._pt = new j(this._pt,v ? g : a,_,c,(x ? Xt(c, x + l) : l) - c,!v && (y === "px" || _ === "zIndex") && e.autoRound !== !1 ? Dn : Ke),
                        this._pt.u = y || 0,
                        m !== y && y !== "%" && (this._pt.b = f,
                        this._pt.r = Mn);
                    else if (_ in a)
                    ...
                    v || (_ in a ? O.push(_, 0, a[_]) : typeof t[_] == "function" ? O.push(_, 2, t[_]()) : O.push(_, 1, f || t[_])),
                    s.push(_)
                }
            }
        P && xr(this)
    ...
    getSetter: function(t, e, i) {
        ...
        e in xt && e !== H && (t._gsap.x || gt(t, "x")) ? i && Pi === i ? e === "scale" ? zn : En : (Pi = i || {}) && (e === "scale" ? Fn : Ln) : t.style && !Je(t.style[e]) ? An : ~e.indexOf("-") ? Rn : fi(t, e)
    },
    core: {
        _removeProperty: Nt,
        _getMatrix: di
